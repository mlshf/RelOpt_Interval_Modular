...
class Ui_ConfigDialog(object):
    def setupUi(self, ConfigDialog):
        ...
        self.rb01 = QtGui.QCheckBox(ConfigDialog)
        self.rb01.setChecked(True)
        self.rb01.setObjectName(_fromUtf8("rb01"))
        self.verticalLayout_10.addWidget(self.rb01)
    ...
    def retranslateUi(self, ConfigDialog):
        ...
        self.rb01.setText(_translate("ConfigDialog", "RB/0/1", None))
